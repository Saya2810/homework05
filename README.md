...
`julia homework05.jl "Bero Verfürth"`
``` julia
==== Analyzing name: "Bero Verfürth" ====
Name-based spinor φ = ComplexF64[-1.9999216527892743 - 0.017702618580807752im, 1.4183109273161312 - 4.794621373315692im, 11.885700748393443 - 13.517770441890171im, 14.40255429975549 - 4.191232472983888im]
Closest valid u-spinor ψ_best = ComplexF64[3.0540510340780904 + 0.0im, 4.819466772768614 - 9.962565446648759im, 6.711908193550909 - 7.637630306766159im, 3.7161562981359713 - 2.8419612043516485im]
Minimal distance d_min = 120.59113647353715
Parameters params_best = SpinorParams(:u, 3.268764275314851, (119.78754129427587, -38.738013718958875, -25.7246061373198), 2.603078474950194, 5.162958443837832)
Reconstructed m  = 3.2687642753148403
Reconstructed E  = 128.5384336960191
Reconstructed p  = (119.78754129427588, -38.73801371895888, -25.724606137319793)
Reconstructed S  = (0.23871166252574308, -0.08214872946199887, -0.06156951357136035)
```

In case a german keyboard is not available (or 'Alt-Codes' are not supported in your environment)
`julia homework05.jl "Bero Verfuerth"`
``` julia
==== Analyzing name: "Bero Verfuerth" ====
Name-based spinor φ = ComplexF64[-1.9999216527892743 - 0.017702618580807752im, 1.4183109273161312 - 4.794621373315692im, 11.885700748393443 - 13.517770441890171im, 14.40255429975549 - 4.191232472983888im]
Closest valid u-spinor ψ_best = ComplexF64[2.8684276846460786 + 0.0im, 7.1654445415077355 - 13.299094124445288im, 5.939014101460922 - 11.74659554745953im, 5.177966015082436 - 4.9079994039960795im]
Minimal distance d_min = 126.5818333233378
Parameters params_best = SpinorParams(:u, 6.141595867199988, (213.6273770705238, -8.892169961542507, -85.33874188721626), 2.7663022411966054, 5.2065864403408275)
Reconstructed m  = 6.141595867199981
Reconstructed E  = 230.29578152312223
Reconstructed p  = (213.62737707052383, -8.892169961542507, -85.33874188721629)
Reconstructed S  = (0.23656068708990155, -0.014053003613644996, -0.1059800322118134)
```
